...
#### The dataset will be split into a seperate training and testing data set to compare models. Each model will be built using the training data then the best model will be determined by its ability to accurately predict the actual average median home price in the testing data set. 
