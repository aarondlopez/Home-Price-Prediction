...
library(reshape2)
library(plyr)
jobs_by_sector  <- read.csv("/Users/aarondlopez/Desktop/Springboard/Capstone Project/Data/jobs_by_sector.csv")
home_prices     <- read.csv("/Users/aarondlopez/Desktop/Springboard/Capstone Project/Data/home_prices.csv")
total_jobs      <- read.csv("/Users/aarondlopez/Desktop/Springboard/Capstone Project/Data/total_jobs.csv")
unemployment    <- read.csv("/Users/aarondlopez/Desktop/Springboard/Capstone Project/Data/unemployment.csv")
apt_rents       <- read.csv("/Users/aarondlopez/Desktop/Springboard/Capstone Project/Data/apt_rents.csv")
...
# Create new csv file
write.csv(clean_df, file = "/Users/aarondlopez/Desktop/Springboard/Capstone Project/Data/clean_df.csv")
