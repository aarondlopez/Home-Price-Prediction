...
jobs_by_sector <- jobs_by_sector %>% 
  gather(Construction, Education, Finance, Information, Hospitality, 
         ...
         key = "Job Sector", value = "Number of Jobs")
...
colnames(clean_df)[4] <- "Average Apt Rent"
colnames(clean_df)[5] <- "Average 1bd Apt Rent"
colnames(clean_df)[6] <- "Average 2bd Apt Rent"
colnames(clean_df)[7] <- "Average Price Single Family Home"
colnames(clean_df)[8] <- "Average Price Condo.Townhome"
colnames(clean_df)[9] <- "Total Jobs"
colnames(clean_df)[10] <- "Unemployment Rate for San Jose"
colnames(clean_df)[11] <- "Unemployment Rate for San Jose Metro Area"
